...
public class TestListners1  implements ITestListener
{
	...
	public void onTestSuccess(ITestResult result) {
	    ...
	    Date d2 =new Date(d1.getTime()+(60*60*1000*24));
	   ...
	   System.out.println(f3);
		...
		File Destination = new File("C:\\Users\\DELL\\eclipse-workspace\\Amazon_project\\target\\Screenshots\\pass"+new TestListners1().getClass()+f3+"+.png" );
		try {
	...
	public void onTestFailure(ITestResult result) {
	   ...
	   System.out.println(f3);
		...
		TakesScreenshot ts = (TakesScreenshot) driver;
		File Source=ts.getScreenshotAs(OutputType.FILE);
		File Destination = new File("C:\\Users\\DELL\\eclipse-workspace\\Amazon_project\\target\\Screenshots\\fail" +new TestListners1().getClass()+f3+"+.png" );
		try {
			FileHandler.copy(Source,Destination);
		} catch (IOException e) {
			// TODO Auto-generated catch block
